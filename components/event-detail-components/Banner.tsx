...
export const Banner = ({ banner_img, name, description, dates_places }: Props) => {
    return (
        <div className='flex flex-col gap-[14px] justify-center w-full h-[80vh] sm:h-[75vh] bg-cover px-10 sm:px-0 2xl:px-[80px] pt-14 sm:pt-4 md:pt-0' style={{ backgroundImage: `url(${banner_img})` }}>
